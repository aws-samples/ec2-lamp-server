...
- [PHP 8.1](https://www.php.net/releases/8.1/en.php), [PHP 8.2](https://www.php.net/releases/8.2/en.php)(Amazon Linux 2 and 2023) or [PHP 8.3](https://www.php.net/releases/8.3/en.php)(Amazon Linux 2023) with common PHP extensions (imagick, apcu, memcached, redis, igbinary, msgpack, lzf, lz4, zstd, libsodium, zip, etc)
