...
*For EC2 origins, [Enable resource name DNS A record on launch](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-naming-modify.html) must be enabled for the subnet*
